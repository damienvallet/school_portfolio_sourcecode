/**
* File Name: VersionCSS.jsx
* Description: Page principale avec CSS
...
// définition du composant VersionCSS
function VersionCSS() {
  return (
...
// Exportation du composant VersionCSS
export default VersionCSS;
