/**
* File Name: VersionMongo.jsx
* Description: Page Principale qui utilise le formulaire avec MongoDB
...
import FormulaireMongo from "./FormulaireMongo.jsx";

// définition du composant VersionMongo
function VersionMongo() {
  return (
