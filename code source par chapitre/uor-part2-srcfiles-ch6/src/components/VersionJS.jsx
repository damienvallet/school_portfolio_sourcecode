/**
* File Name: VersionJS.jsx
* Description: Page principale de la version JavaScript
...
import { changeBgColor, changeTextColor, animateImage } from "../commonJS.js";

// définition du composant versionJS
function VersionJS() {
  ...
  const changeColor = (color) => {
    changeBgColor(color);
    changeTextColor(color === "white" ? "black" : "white");
  }
          ...
          <div className="container">
            <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
              ...
              <ul className="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                ...
                <li>
                  <a className="nav-link px-2 text-light" href="#livredor" />
                </li>

                {/*  boutons pour changer la couleur de la page */}
                <li>
                  <button className="btn mx-2 btn-outline-light" onClick={() => changeColor("black")}>
                    Dark
                  </button>
                </li>
                <li>
                  <button className="btn mx-2 btn-outline-light" onClick={() => changeColor("white")}>
                    Light
                  </button>
                </li>
              </ul>
            ...
            <div className="col d-flex justify-content-center">
              <figure id="contact_mail">
                <a href="mailto:damienjdvallet@gmail.com">
                  <img id="contactimg" src={picofme} alt="portait de Damien Vallet" width="270" height="250" className="img-fluid rounded mx-auto d-block" onMouseOver={changeImageSize} />
...
// Exportation du composant VersionJS
export default VersionJS;
