...
function FormulaireMongo() {
    ...
    const recupereMessages = async () => {
        ...
        const reponse = await fetch('http://localhost:5000/commentaires')
    ...
    const handleChange = (e) => {
        ...
        // on récupère le nom et la valeur du champ
                            ...
                            messages.map((message, index) => (
                                ...
                                <div key={index} className="card mb-3">
                                    ...
                                    <div className="card-header d-flex flex-wrap justify-content-between">
                                        ...
                                        <p className="card-text px-2"><strong>Genre:</strong> {message.genre}</p>
...
// Exportation du composant FormulaireMongo
export default FormulaireMongo